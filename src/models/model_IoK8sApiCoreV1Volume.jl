...
Base.@kwdef mutable struct IoK8sApiCoreV1Volume <: OpenAPI.APIModel
    ...
    ephemeral = nothing # spec type: Union{ Nothing, IoK8sApiCoreV1EphemeralVolumeSource }
    ...
    function IoK8sApiCoreV1Volume(awsElasticBlockStore, azureDisk, azureFile, cephfs, cinder, configMap, csi, downwardAPI, emptyDir, ephemeral, fc, flexVolume, flocker, gcePersistentDisk, gitRepo, glusterfs, hostPath, iscsi, name, nfs, persistentVolumeClaim, photonPersistentDisk, portworxVolume, projected, quobyte, rbd, scaleIO, secret, storageos, vsphereVolume, )
        ...
        OpenAPI.validate_property(IoK8sApiCoreV1Volume, Symbol("ephemeral"), ephemeral)
