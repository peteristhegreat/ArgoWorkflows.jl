...
Base.@kwdef mutable struct IoK8sApiCoreV1VolumeProjection <: OpenAPI.APIModel
    clusterTrustBundle = nothing # spec type: Union{ Nothing, IoK8sApiCoreV1ClusterTrustBundleProjection }
    ...
    function IoK8sApiCoreV1VolumeProjection(clusterTrustBundle, configMap, downwardAPI, secret, serviceAccountToken, )
        OpenAPI.validate_property(IoK8sApiCoreV1VolumeProjection, Symbol("clusterTrustBundle"), clusterTrustBundle)
        ...
        return new(clusterTrustBundle, configMap, downwardAPI, secret, serviceAccountToken, )
    end
end # type IoK8sApiCoreV1VolumeProjection

const _property_types_IoK8sApiCoreV1VolumeProjection = Dict{Symbol,String}(Symbol("clusterTrustBundle")=>"IoK8sApiCoreV1ClusterTrustBundleProjection", Symbol("configMap")=>"IoK8sApiCoreV1ConfigMapProjection", Symbol("downwardAPI")=>"IoK8sApiCoreV1DownwardAPIProjection", Symbol("secret")=>"IoK8sApiCoreV1SecretProjection", Symbol("serviceAccountToken")=>"IoK8sApiCoreV1ServiceAccountTokenProjection", )
