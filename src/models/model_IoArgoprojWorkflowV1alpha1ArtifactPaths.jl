...
@doc raw"""io.argoproj.workflow.v1alpha1.ArtifactPaths
...
"""
Base.@kwdef mutable struct IoArgoprojWorkflowV1alpha1ArtifactPaths <: OpenAPI.APIModel
    ...
    function IoArgoprojWorkflowV1alpha1ArtifactPaths(archive, archiveLogs, artifactGC, artifactory, azure, deleted, from, fromExpression, gcs, git, globalName, hdfs, http, mode, name, optional, oss, path, raw, recurseMode, s3, subPath, )
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("archive"), archive)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("archiveLogs"), archiveLogs)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("artifactGC"), artifactGC)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("artifactory"), artifactory)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("azure"), azure)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("deleted"), deleted)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("from"), from)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("fromExpression"), fromExpression)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("gcs"), gcs)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("git"), git)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("globalName"), globalName)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("hdfs"), hdfs)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("http"), http)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("mode"), mode)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("name"), name)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("optional"), optional)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("oss"), oss)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("path"), path)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("raw"), raw)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("recurseMode"), recurseMode)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("s3"), s3)
        OpenAPI.validate_property(IoArgoprojWorkflowV1alpha1ArtifactPaths, Symbol("subPath"), subPath)
...
end # type IoArgoprojWorkflowV1alpha1ArtifactPaths

const _property_types_IoArgoprojWorkflowV1alpha1ArtifactPaths = Dict{Symbol,String}(Symbol("archive")=>"IoArgoprojWorkflowV1alpha1ArchiveStrategy", Symbol("archiveLogs")=>"Bool", Symbol("artifactGC")=>"IoArgoprojWorkflowV1alpha1ArtifactGC", Symbol("artifactory")=>"IoArgoprojWorkflowV1alpha1ArtifactoryArtifact", Symbol("azure")=>"IoArgoprojWorkflowV1alpha1AzureArtifact", Symbol("deleted")=>"Bool", Symbol("from")=>"String", Symbol("fromExpression")=>"String", Symbol("gcs")=>"IoArgoprojWorkflowV1alpha1GCSArtifact", Symbol("git")=>"IoArgoprojWorkflowV1alpha1GitArtifact", Symbol("globalName")=>"String", Symbol("hdfs")=>"IoArgoprojWorkflowV1alpha1HDFSArtifact", Symbol("http")=>"IoArgoprojWorkflowV1alpha1HTTPArtifact", Symbol("mode")=>"Int64", Symbol("name")=>"String", Symbol("optional")=>"Bool", Symbol("oss")=>"IoArgoprojWorkflowV1alpha1OSSArtifact", Symbol("path")=>"String", Symbol("raw")=>"IoArgoprojWorkflowV1alpha1RawArtifact", Symbol("recurseMode")=>"Bool", Symbol("s3")=>"IoArgoprojWorkflowV1alpha1S3Artifact", Symbol("subPath")=>"String", )
OpenAPI.property_type(::Type{ IoArgoprojWorkflowV1alpha1ArtifactPaths }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoArgoprojWorkflowV1alpha1ArtifactPaths[name]))}

function check_required(o::IoArgoprojWorkflowV1alpha1ArtifactPaths)
    o.name === nothing && (return false)
    true
end

function OpenAPI.validate_property(::Type{ IoArgoprojWorkflowV1alpha1ArtifactPaths }, name::Symbol, val)
end
